...
// also appended to the tooltip ("Prata — Rngv GPU-server (Tailscale)"). Like SetOnCheckUpdate it
...
func (t *Tray) buildMenu() (uintptr, error) {
	...
	// Backend radio items (Rngv GPU-server (Tailscale) / LAN GPU-server / Berget Ai) at the
